...
$(function(){
  ...
  //OEM合同模块开始
	...
	$(".order_flow").mouseover(function (){
   	...
   	//点击按钮式触发变化OEM订单信息
   	$(".order_oem_menu").on('click',function(){
   		$(".order_oem_menu").css("background","#03a9f4");
   		$(".order_weld_menu").css("background","#c7d1d4");
   		$(".order_main_oem").show();
   		$(".order_main_weld").hide();
   	});

   	//点击按钮式触发变化焊接订单信息
	$(".order_weld_menu").on('click',function(){
   		$(".order_weld_menu").css("background","#03a9f4");
   		$(".order_oem_menu").css("background","#c7d1d4");
   		$(".order_main_oem").hide();
   		$(".order_main_weld").show();
  });
    ...
    $(".product_oem").on('click',function(){
        ...
        $.getJSON({
            ...
            success:function(result,data){
                if(result.state==200){
                    if(result.product_class_type=="oem"){
                    //产品型号
                        var html_product;
  ...
  //获取焊接订单时间段查询
    ...
    $(".product_weld").on('click',function(){
        ...
        $.getJSON({
            ...
            success:function(result,data){
                if(result.state==200){
                    if(result.product_class_type=="焊接"){
                    //产品型号
                        var html_product;
                        html_product = '<div class="col-md-4 product_list" data-field="product_id" data-align="center">'+result.product_number+'</div>'+
                                        '<div class="col-md-4 product_list" data-field="product_id" data-align="center">'+result.product_name+'</div>'+
